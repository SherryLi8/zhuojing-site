...
export const works = [
  ...
  },
  {
    ...
    tagDisplay: "Experimental Editorial · Dragon Scale Binding",
    tagDisplayZh: "实验性出版物 · 龙鳞装",
