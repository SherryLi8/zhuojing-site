...
const photoGrids: Record<string, { id: string; aspect: string; src: string }[]> = {
  ...
  "guiyang": [
    { id: "gy0",  aspect: "3/2", src: `${P}/2.Guiyang/LP.jpg` },
    ...
    { id: "gy4",  aspect: "3/2", src: `${P}/2.Guiyang/未命名-16.jpg` },
    { id: "gy5",  aspect: "3/2", src: `${P}/2.Guiyang/未命名-19.jpg` },
    { id: "gy6",  aspect: "3/2", src: `${P}/2.Guiyang/未命名-25.jpg` },
    { id: "gy7",  aspect: "3/2", src: `${P}/2.Guiyang/未命名-27.jpg` },
    { id: "gy8",  aspect: "3/2", src: `${P}/2.Guiyang/未命名-28.jpg` },
    { id: "gy9",  aspect: "3/2", src: `${P}/2.Guiyang/未命名-36.jpg` },
  ],
  "los-angeles": [
